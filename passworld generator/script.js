...
const upper = document.getElementsById('upper');
const lower = document.getElementsById('lower');
const number = document.getElementsById('number');
const symbol = document.getElementsById('symbol');
const generate = document.getElementsById('generate');
